About asciitree-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/asciitree-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2715&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/asciitree-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `asciitree` can be installed with `conda`:
...
```
mamba install asciitree
```

It is possible to list all of the versions of `asciitree` available on your platform with `conda`:
...
```
mamba search asciitree --channel conda-forge
```
...
mamba repoquery search asciitree --channel conda-forge

# List packages depending on `asciitree`:
mamba repoquery whoneeds asciitree --channel conda-forge

# List dependencies of `asciitree`:
mamba repoquery depends asciitree --channel conda-forge
```
